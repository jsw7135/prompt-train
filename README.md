...
서비스운영팀을 위한 **프롬프트 훈련** + **보안·IT 뉴스** 통합 플랫폼입니다.
...
- **국내 우선**: 국내 RSS 피드 비중 확대, 국내 이슈 탭 기본 표시
- **핵심 요약**: 기사 본문에서 핵심 문장을 추출해 요약 제공
- **출처**: 보안뉴스, 전자신문(3종), The Hacker News, BleepingComputer, Krebs, Ars Technica
